...
const te: TranslationKeys = {
  ...
  trustedHealthPlatform: "నమ్మకమైన ఆరోగ్య సమాచార వేదిక",
  topicsCount: "12+ అంశాలు",
  topicsCountDesc: "నమ్మకమైన సమాచారం",
  aiAssistantLabel: "AI సహాయకుడు",
  aiAssistantDesc: "24/7 సహాయం",
  homeLearnAbout: "సాధారణ ఆరోగ్య పరిస్థితులు మరియు ఆందోళనల గురించి తెలుసుకోండి.",
  homeDiscoverWays: "ఆరోగ్య ప్రమాదాలను తగ్గించే ఆచరణాత్మక మార్గాలను కనుగొనండి.",
  homeLearnTips: "పోషకాహారం, వ్యాయామం, నిద్ర మరియు శ్రేయస్సు గురించి తెలుసుకోండి.",
  homeUnderstandSymptoms: "సాధారణ లక్షణాలు మరియు హెచ్చరిక సంకేతాలను అర్థం చేసుకోండి.",
  homeExploreAwareness: "అవగాహన ప్రచారాలు మరియు ప్రజారోగ్య చర్యలను అన్వేషించండి.",
  homeEmergencyInfo: "అత్యవసర వైద్య సహాయం ఎప్పుడు అవసరమో తెలుసుకోండి.",
  homeCardTopicsDesc: "సాధారణ ఆరోగ్య పరిస్థితులు మరియు ఆందోళనల గురించి తెలుసుకోండి.",
  homeCardPreventionDesc: "ఆరోగ్య ప్రమాదాలను తగ్గించే ఆచరణాత్మక మార్గాలను కనుగొనండి.",
  homeCardLifestyleDesc: "పోషకాహారం, వ్యాయామం, నిద్ర మరియు శ్రేయస్సు గురించి తెలుసుకోండి.",
  homeCardSymptomsDesc: "సాధారణ లక్షణాలు మరియు హెచ్చరిక సంకేతాలను అర్థం చేసుకోండి.",
  homeCardCampaignsDesc: "అవగాహన ప్రచారాలు మరియు ప్రజారోగ్య చర్యలను అన్వేషించండి.",
  homeCardEmergencyDesc: "అత్యవసర వైద్య సహాయం ఎప్పుడు అవసరమో తెలుసుకోండి.",
  homeTipDesc: "మీ రోజును మెరుగుపరచడానికి ఒక త్వరిత ఆరోగ్య చిట్కా.",
  homeStartYourJourney: "మీ ఆరోగ్య ప్రయాణాన్ని ఈరోజే ప్రారంభించండి",
  homeStartDesc: "ప్రతి రోజూ మెరుగైన ఆరోగ్య ఎంపికలు చేస్తున్న వేలాది మందితో చేరండి.",
  homeJoinNow: "ఇప్పుడే చేరండి — ఉచితం",
  homeReadArticles: "తాజా ఆరోగ్య వ్యాసాలు మరియు పరిశోధన ఆధారిత అంతర్దృష్టులను చదవండి.",
  homeReadArticlesDesc: "తాజా ఆరోగ్య వార్తలు మరియు నిపుణుల సలహాతో సమాచారం పొందండి.",
  homeViewAllEvents: "రాబోయే ఆరోగ్య అవగాహన సంఘటనలు మరియు ప్రచారాలను చూడండి.",
  homeViewAllEventsDesc: "ముఖ్యమైన ఆరోగ్య అవగాహన రోజును ఎప్పుడూ మిస్ అవ్వకండి.",
  
  // About page
  aboutSubtitle: "ప్రతి ఒక్కరికీ, ఎక్కడైనా నమ్మకమైన ఆరోగ్య సమాచారాన్ని అందుబాటులో ఉంచడం మా లక్ష్యం.",
  missionTitle: "మా లక్ష్యం",
  missionDesc: "ప్రతి ఒక్కరూ నమ్మకమైన ఆరోగ్య సమాచారాన్ని యాక్సెస్ చేయగలరని మేము నమ్ముతున్నాము.",
  valuesTitle: "మా విలువలు",
  valueEvidence: "ఆధారం ఆధారంగా",
  valueEvidenceDesc: "మా కంటెంట్ అంతా ఆరోగ్య నిపుణులచే సమీక్షించబడి తాజా వైద్య పరిశోధనపై ఆధారపడి ఉంటుంది.",
  valueAccessible: "అందరికీ యాక్సెస్‌బిల్",
  valueAccessibleDesc: "మేము ఆరోగ్య సమాచారాన్ని సరళమైన భాషలో అందిస్తాము.",
  valueCommunity: "సమాజం కేంద్రంగా",
  valueCommunityDesc: "అవగాహన మరియు నివారణ ఆరోగ్య పద్ధతులను ప్రోత్సహించడం ద్వారా ఆరోగ్యకరమైన సమాజాన్ని నిర్మించడానికి మేము కట్టుబడి ఉన్నాము.",
  educationalDisclaimer: "ఈ వేదిక విద్యాత్మక మరియు అవగాహన ప్రయోజనాల కోసం మాత్రమే. వృత్తిపరమైన వైద్య సలహాకు ప్రత్యామ్నాయం కాదు.",
  
  // Contact page
  contactSubtitle: "ప్రశ్నలు లేదా అభిప్రాయాలు ఉన్నాయా? మేము మీ నుండి వినాలనుకుంటున్నాము.",
  contactInfo: "సంప్రదింపు సమాచారం",
  contactName: "మీ పేరు",
  contactEmail: "మీ ఇమెయిల్",
  contactSubject: "సబ్జెక్ట్",
  contactMessage: "మీ సందేశం",
  contactSend: "సందేశం పంపండి",
  contactSent: "సందేశం పంపబడింది!",
  contactSentDesc: "సంప్రదించినందుకు ధన్యవాదాలు. మేము 24 గంటల్లో ప్రతిస్పందిస్తాము.",
  contactPhoneLabel: "ఫోన్",
  contactEmailLabel: "ఇమెయిల్",
  contactHoursLabel: "పని గంటలు",
  contactResponseTime: "ప్రతిస్పందన సమయం",
  contactResponseDesc: "సాధారణంగా 24 గంటల్లో ప్రతిస్పందిస్తాము.",
  
  // Bookmarks page
  noBookmarks: "ఇంకా బుక్‌మార్కులు లేవు",
  allItems: "అన్ని అంశాలు",
  remove: "తొలగించండి",
  
  // Search page
  searchResults: "శోధన ఫలితాలు",
  noResultsDesc: "మీరు వెతుకుతున్నది కనుగొనడానికి భిన్నమైన పదాలతో ప్రయత్నించండి.",
  searchingFor: "శోధిస్తోంది",
  
  // Dashboard body
  dashWelcome: "తిరిగి స్వాగతం",
  dashWelcomeDesc: "ఇది మీ ఆరోగ్య డాష్‌బోర్డ్.",
  dashStats: "మీ గణాంకాలు",
  dashSaved: "సేవ్ చేసిన అంశాలు",
  dashTopicsExplored: "అంశాలు",
  dashArticlesRead: "వ్యాసాలు",
  dashQuickActions: "త్వరిత చర్యలు",
  dashBrowseTopics: "అంశాలను బ్రౌజ్ చేయండి",
  dashBrowseTopicsDesc: "12+ ఆరోగ్య అంశాలను అన్వేషించండి",
  dashViewBookmarks: "బుక్‌మార్కులు చూడండి",
  dashViewBookmarksDesc: "మీ సేవ్ చేసిన కంటెంట్‌ను యాక్సెస్ చేయండి",
  dashBrowseArticles: "వ్యాసాలు చదవండి",
  dashBrowseArticlesDesc: "తాజా ఆరోగ్య అంతర్దృష్టులు",
  dashDailyTip: "ఈ రోజు శ్రేయస్సు చిట్కా",
  dashLearnPrevention: "నివారణ గైడ్",
  dashLearnPreventionDesc: "ఆచరణాత్మక ఆరోగ్య చిట్కాలు",
  dashLifestyle: "ఆరోగ్యకరమైన జీవనశైలి",
  dashLifestyleDesc: "రోజువారీ శ్రేయస్సు అలవాట్లు",
  dashCheckSymptoms: "లక్షణాలను తనిఖీ చేయండి",
  dashCheckSymptomsDesc: "హెచ్చరిక సంకేతాలను అర్థం చేసుకోండి",
  
  // Prevention page body
  preventionEatWell: "బాగా తినండి",
  preventionEatWellDesc: "పండ్లు, కూరగాయలు, ధాన్యాలు మరియు మాంసకృత్తులతో సమతుల్య ఆహారం వ్యాధి నివారణలో అత్యంత శక్తివంతమైన సాధన.",
  preventionExercise: "క్రమం తప్పకుండా వ్యాయామం చేయండి",
  preventionExerciseDesc: "వారానికి కనీసం 150 నిమిషాల మధ్యస్థ శారీరక శ్రమను లక్ష్యంగా చేసుకోండి.",
  preventionSleep: "నిద్రకు ప్రాధాన్యత ఇవ్వండి",
  preventionSleepDesc: "ప్రతి రాత్రి 7-9 గంటల నాణ్యమైన నిద్ర అవసరం.",
  preventionHygiene: "మంచి పరిశుభ్రతను పాటించండి",
  preventionHygieneDesc: "సబ్బు మరియు నీటితో తరచుగా చేతులు కడుక్కోండి.",
  preventionVaccines: "వ్యాక్సిన్లతో క్రమం తప్పకండి",
  preventionVaccinesDesc: "వ్యాక్సిన్లు తీవ్రమైన వ్యాధులను నివారించడంలో అత్యంత సురక్షితమైన మార్గం.",
  preventionMentalHealth: "మీ మానసిక ఆరోగ్యాన్ని రక్షించండి",
  preventionMentalHealthDesc: "ధ్యానం, లోతైన శ్వాసపోటు ద్వారా ఒత్తిడిని నిర్వహించండి.",
  preventionScreenings: "క్రమం తప్పకుండా స్క్రీనింగ్లు చేయించుకోండి",
  preventionScreeningsDesc: "క్రమం తప్పకుండా ఆరోగ్య స్క్రీనింగ్లు పరిస్థితులను ముందుగానే గుర్తించగలవు.",
  preventionHydration: "హైడ్రేటెడ్‌గా ఉండండి",
  preventionHydrationDesc: "రోజూ కనీసం 8 గ్లాసుల నీరు తాగండి.",
  preventionSunProtection: "సూర్యరశ్మి నుండి మీ చర్మాన్ని రక్షించండి",
  preventionSunProtectionDesc: "SPF 30 లేదా అంతకంటే ఎక్కువ సన్‌స్క్రీన్ ఉపయోగించండి.",
  preventionAvoidTobacco: "తంబాకును నివారించండి మరియు మద్యం పరిమితం చేయండి",
  preventionAvoidTobaccoDesc: "ధూమపానం నివారించగల మరణానికి ప్రధాన కారణం.",
  
  // Lifestyle page body
  lifestyleEatBetter: "బాగా తినండి",
  lifestyleEatBetterDesc: "పోషకాహారపు ఆహారంతో మీ శరీరానికి ఇంధనం అందించండి.",
  lifestyleMoveMore: "ఎక్కువ కదలండి",
  lifestyleMoveMoreDesc: "మీకు ఇష్టమైన కార్యకలాపాలను కనుగొని మీ దినచర్యలో భాగం చేసుకోండి.",
  lifestyleSleepWell: "బాగా నిద్రపోండి",
  lifestyleSleepWellDesc: "ఒక ప్రశాంతమైన నిద్ర దినచర్యను సృష్టించండి.",
  lifestyleStayHydrated: "హైడ్రేటెడ్‌గా ఉండండి",
  lifestyleStayHydratedDesc: "నీరు మీ శరీరంలోని ప్రతి పనితీరుకు అవసరం.",
  lifestyleManageStress: "ఒత్తిడిని నిర్వహించండి",
  lifestyleManageStressDesc: "దీర్ఘకాలిక ఒత్తిడి మీ శరీరం మరియు మనసుకు హాని చేయవచ్చు.",
  lifestyleMaintainHygiene: "మంచి పరిశుభ్రతను కాపాడుకోండి",
  lifestyleMaintainHygieneDesc: "చేతులు కడుక్కోవడం, రోజూ రెండుసార్లు పళ్ళు తోముకోవడం వంటి సరళమైన అలవాట్లు సోంక్రమణాలను నివారించగలవు.",
  
  // Calendar page body
  calendarEventDetails: "సంఘటన వివరాలు",
  calendarIn: "లో",
  calendarDays: "రోజులు",
  calendarPast: "గతం",
  calendarNoEvents: "ఈ నెలకు సంఘటనలు లేవు",
  
  // Emergency page body
  emergencyCallEmergency: "అత్యవసర సేవలను కాల్ చేయండి",
  emergencyCallEmergencyDesc: "వైద్య అత్యవసర పరిస్థితిలో వెంటనే మీ స్థానిక అత్యవసర నంబర్‌కు కాల్ చేయండి.",
  emergencyWhenToCall: "అత్యవసర సేవలను ఎప్పుడు కాల్ చేయాలి",
  emergencyWhenToCallDesc: "ఛాతీ నొప్పి, శ్వాస తీసుకోవడంలో కష్టం, తీవ్ర రక్తస్రావం వంటి పరిస్థితులలో వెంటనే కాల్ చేయండి.",
  emergencyCPRTitle: "CPR ప్రాథమికాలు",
  emergencyCPRDesc: "ఎవరైనా కుప్పకూలి సాధారణంగా శ్వాసించకపోతే: అత్యవసర సేవలకు కాల్ చేయండి.",
  emergencyChokingTitle: "గొంతులో అడ్డు ప్రాథమిక చికిత్స",
  emergencyChokingDesc: "స్పృహలో ఉన్న గొంతులో అడ్డు వచ్చిన పెద్దవారికి: వెనుక నిలబడి, వేగంగా పైకి నొక్కండి.",
  emergencyBleedingTitle: "తీవ్ర రక్తస్రావాన్ని నియంత్రించండి",
  emergencyBleedingDesc: "శుభ్రమైన గుడ్డ తో గట్టిగా ఒత్తిడి వర్తించండి.",
  emergencyStrokeTitle: "FAST స్ట్రోక్ గుర్తింపు",
  emergencyStrokeDesc: "F — ముఖం, A — చేతులు, S — మాట, T — సమయం: ఏదైనా ఉంటే వెంటనే అత్యవసర సేవలకు కాల్ చేయండి.",
  emergencyBurnTitle: "కాలిన గాయం ప్రాథమిక చికిత్స",
  emergencyBurnDesc: "కాలిన గాయాన్ని కనీసం 20 నిమిషాలు చల్లటి నీటి కింద చల్లబరచండి.",
  
  // Symptoms page body
  symptomsChestPain: "ఛాతీ నొప్పి లేదా అసౌకర్యం",
  symptomsShortBreath: "శ్వాస తీసుకోవడంలో కష్టం",
  symptomsSevereHeadache: "తీవ్రమైన తలనొప్పి",
  symptomsHighFever: "అధిక జ్వరం",
  symptomsAbdominalPain: "నిరంతరం ఉదర నొప్పి",
  symptomsVisionChanges: "అకస్మాత్తుగా దృష్టి మార్పులు",
  symptomsFatigue: "అలసట లేదా బలహీనత",
  symptomsJointPain: "కీళ్ల నొప్పి లేదా వాపు",
  symptomsRash: "దద్దుర్లు లేదా చర్మ మార్పులు",
  symptomsNausea: "నిరంతరం వాంతులు లేదా వికారం",
  symptomsDizziness: "తలతిప్పుట లేదా స్పృహ కోల్పోవడం",
  symptomsBackPain: "తీవ్రమైన వెన్నునొప్పి",
  symptomsSwelling: "అస్పష్టమైన వాపు",
  symptomsCough: "నిరంతరం దగ్గు",
  symptomsInsomnia: "నిద్రపోవడంలో కష్టం",
  symptomsWeightChange: "బరువు మార్పు",
  symptomsAnxiety: "ఆందోళన లేదా పానిక్ దాడులు",
  symptomsAllergies: "అలర్జీ ప్రతిచర్యలు",
  
  // Footer body
  footerAbout: "మా గురించి",
  footerAboutDesc: "డిజిటల్ హెల్త్ అవేర్‌నెస్ పోర్టల్ నమ్మకమైన ఆరోగ్య సమాచారాన్ని అందిస్తుంది.",
  ...
  // Registration login extra
  regStep1Title: "వ్యక్తిగత సమాచారం",
  regStep1Desc: "మీ గురించి మాకు కొంచెం చెప్పండి",
  regProvideEmailOrPhone: "దయచేసి ఇమెయిల్ లేదా ఫోన్ నంబర్ అందించండి",
  regAccountInfo: "ఖాతా సమాచారం",
  regCreateSecure: "మీ ఖాతా కోసం సురక్షితమైన పాస్‌వర్డ్ సృష్టించండి",
  regSecureNote: "మీ ఖాతా సమాచారం మీ బ్రౌజర్‌లో సురక్షితంగా సేవ్ చేయబడుతుంది.",
  regJoinDescription: "ఉచిత ఖాతాను సృష్టించి ఆరోగ్య అంశాలు, ప్రచారాలు, బుక్‌మార్కులు మరియు రోజువారీ చిట్కాలకు యాక్సెస్ పొందండి.",
  loginEmailOrPhone: "ఇమెయిల్ లేదా ఫోన్",
  loginPasswordLabel: "పాస్‌వర్డ్",
  loginNewUser: "పోర్టల్ కొత్తగా ఉందా? ఖాతా సృష్టించండి.",
  loginCreateOne: "ఉచితంగా సృష్టించండి",
  
  // AI Chat body
  aiDisclaimer: "విద్యాత్మక సమాచారం మాత్రమే. వైద్య సలహా కాదు.",
  
  // Language selector body
  langTitle: "మీ భాషను ఎంచుకోండి",
  langDesc: "కొనసాగించడానికి మీ ప్రాధాన్య భాషను ఎంచుకోండి.",

  loginDemoNote: "OTP ధృవీకరణ అవసరం లేదు. మీ ఆధారాలతో లాగిన్ చేయండి.",
